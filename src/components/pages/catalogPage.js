  ...
  const [items] = useState([
    {
      ...
      imgSrc: "https://cdn.shopify.com/s/files/1/0419/1525/files/2800x1080-Women-Combat-Black-1_800x533_crop_right.jpg?v=1603303506",
      imgAlt: "boots",
    ...
    <div className="page">
      <div className="filter-menu">
        <div className="filters">
          <DropdownItem name={'filter1'} clsName={'dropdown'} options={filter1}/>
          <DropdownItem name={'filter1'} clsName={'dropdown'} options={filter1}/>
          <DropdownItem name={'filter1'} clsName={'dropdown'} options={filter1}/>
        </div>
